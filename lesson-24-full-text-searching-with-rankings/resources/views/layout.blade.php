      ...
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center">
          <div class="flex-shrink-0 flex items-center">
            ...
            <span class="ml-2 text-white font-bold text-xl">Blog</span>
          </div>
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline">
              ...
              <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Authors</a>
